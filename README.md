...
The [`06.2_imports`](https://github.com/mjfrigaard/sap/tree/06.2_imports) branch of `sap` covers how to import functions and packages into your app-package.


### NAMESPACE 

The `NAMESPACE` in this branch imports `shiny` and `.data` from `rlang` 
