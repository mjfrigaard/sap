...
The [`06.1_pkg-exports`](https://github.com/mjfrigaard/moviesApp/tree/06.1_pkg-exports) branch of `moviesApp` covers how to export functions from our package for users in the `NAMESPACE`
