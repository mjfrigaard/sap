...
[`09.4_inst-prod`](https://github.com/mjfrigaard/moviesApp/tree/09.4_inst-prod) gives an example of storing a 'production' version of your application in the `inst/prod/` folder.
