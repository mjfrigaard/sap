...
The [`02.3_proj-app`](https://github.com/mjfrigaard/shinyAppPkgs/tree/02.3_proj-app) branch of `shinyAppPkgs` includes and `R/` folder and external resources have been included in `www`. 
