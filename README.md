...
[`09.3_inst-dev`](https://github.com/mjfrigaard/shinyrPkgs/tree/09.3_inst-dev) stores a development version of the primary application in `inst/dev/`.
...
Launch the development data app with: 
