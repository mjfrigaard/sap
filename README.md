...
The [`02.2_movies-app`](https://github.com/mjfrigaard/shinyAppPkgs/tree/02.2_movies-app) branch of `shinyAppPkgs` includes the code for the movie review data (from the [Building Web Applications with Shiny](https://rstudio-education.github.io/shiny-course/) course), a utility function (stored in `utils.R`), and an `app.R` file:
