...
The [`06.1_pkg-exports`](https://github.com/mjfrigaard/shinyrPkgs/tree/06.1_pkg-exports) branch of `shinyrPkgs` covers how to export functions from our package for users in the `NAMESPACE`:
