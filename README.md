...
The [`06.1_pkg-exports`](https://github.com/mjfrigaard/shinyAppPkgs/tree/06.1_pkg-exports) branch of `shinyAppPkgs` covers how to export functions from our package for users in the `NAMESPACE`:
