...
[`09.2_inst-bslib`](https://github.com/mjfrigaard/sap/tree/09.2_inst-bslib) covers how to store external files use the application UI function to display alternative versions of your app.
