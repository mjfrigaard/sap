...
[`09.1_inst-www`](https://github.com/mjfrigaard/shinyAppPkgs/tree/09.1_inst-www) shows how to add external resources in your app-package (i.e., the files previously stored in `www/`).
